...
public class MyService extends Service {
    ...
    private void showNotification() {
        ...
        Log.i(LOGTAG, "====> showNotification (TODO:)");


        //Ajustar setLatestEventInfo pois esta deprecado
    ...
    */
    ...
    public void onDestroy() {
        ...
        counter=0;
        mNotificationManager.cancel(NOTIFICATION_ID /*R.string.service_started*/); // Cancel the persistent notification.
